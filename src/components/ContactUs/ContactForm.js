...
export default function ContactForm() {
    return (
        <div className='ContactForm mx-5 py-5 d-flex justify-content-around align-items-center flex-column flex-sm-row'>
            <div className='ContactForm-OurContacts mb-4 mb-sm-0 d-flex justify-content-center align-items-start align-items-sm-center flex-column'>
            ...
            <div className='ContactForm-OurContacts'>
                <form className='w-100 d-flex justify-content-center align-items-center flex-column'>
                    <input style={{ border: "2px solid #E5E5E5" }} className='formInputs rounded-5 px-3 py-2 mb-3' type="text" name="name" id="name" placeholder='Name' />
                    <input style={{ border: "2px solid #E5E5E5" }} className='formInputs rounded-5 px-3 py-2 mb-3' type="text" name="email" id="email" placeholder='Email' />
                    <textarea style={{ border: "2px solid #E5E5E5", resize: "none" }} className='formInputs rounded-5 px-3 py-2 mb-3' name="comment" id="comment" rows="6" placeholder='Type your message here..' ></textarea>
                    <div className='formInputs d-flex justify-content-end align-items-center'>
